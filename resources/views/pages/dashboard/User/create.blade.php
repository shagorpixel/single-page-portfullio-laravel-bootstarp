        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                <div class="card card-primary ">
                    ...
                    <form class="row" method="POST" action="{{ route('user.store') }}" method="POST"
                        ...
                        <div class="card-body col-md-6">
                            ...
                            <div class="form-group mb-2">
                                ...
                                @endif
                                <textarea class="col-12 form-control" placeholder="about Description" name="description" id="" rows="10"></textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
