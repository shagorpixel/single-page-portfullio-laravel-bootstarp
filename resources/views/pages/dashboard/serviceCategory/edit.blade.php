                        ...
                        <div class="card-body col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control" id="name"
                                   value="{{$serviceCategory->name}}" placeholder="Name">
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                <textarea class=" d-block w-100 p-2 form-control" id="description" name="description" placeholder="Category Description" id="" cols="30" rows="10">{{$serviceCategory->description}}</textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
