...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Masthead-->
        <header style=" background-image:url('{{$main->bg_image?asset('upload/img/'.$main->bg_image):asset('assets/img/header-bg.jpg')}}');" class="masthead">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal{{$portfullio->id}}">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="{{$portfullio->image?asset('images/'.$portfullio->image):asset('assets/img/portfolio/1.jpg') }}" alt="..." />
                            </a>
        ...
        @foreach ($portfullios as $portfullio)
        <div class="portfolio-modal modal fade" id="portfolioModal{{$portfullio->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="{{$portfullio->image?asset('images/'.$portfullio->image):asset('assets/img/portfolio/1.jpg') }}" alt="..." />
